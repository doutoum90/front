...
export const Regulations = () => {
    ...
    const statusColors = {
        active: useColorModeValue('green', 'green.200'),
        review: useColorModeValue('yellow', 'yellow.200'),
        expired: useColorModeValue('red', 'red.200'),
        default: useColorModeValue('gray', 'gray.200'),
    };
    const containerBg = useColorModeValue('gray.50', 'gray.900');
    const tagColor = useColorModeValue('blue', 'blue.200');
    const tableColorScheme = useColorModeValue('purple', 'gray');
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            ...
            case 'En révision': return statusColors.review;
            case 'Expirée': return statusColors.expired;
                        ...
                        {regulations.map((regulation) => (
                            <Tr key={regulation.title} _hover={{ bg: hoverBg }}>
                                <Td fontWeight="medium">
                                    <Tag variant="subtle" color={tagColor} mr={2}>
                                        <FiFileText />
                                    </Tag>
                                    {regulation.title}
                                </Td>
